!function (e, t) {
    ...
    function w(e, t, n, i, r) {
        for (var o, s, a, l, c, u, f = t.createDocumentFragment(), d = [], h = 0, p = e.length; h < p; h++) if ((o = e[h]) || 0 === o) if ("object" === pe.type(o)) pe.merge(d, o.nodeType ? [o] : o); else if (Xe.test(o)) {
            for (s = s || f.appendChild(t.createElement("div")), a = ($e.exec(o) || ["", ""])[1].toLowerCase(), l = ze[a] || ze._default, s.innerHTML = l[1] + pe.htmlPrefilter(o) + l[2], u = l[0]; u--;) s = s.lastChild;
            pe.merge(d, s.childNodes), (s = f.firstChild).textContent = ""
        } else d.push(t.createTextNode(o));
        for (f.textContent = "", h = 0; o = d[h++];) if (i && pe.inArray(o, i) > -1) r && r.push(o); else if (c = pe.contains(o.ownerDocument, o), s = y(f.appendChild(o), "script"), c && b(s), n) for (u = 0; o = s[u++];) Qe.test(o.type || "") && n.push(o);
        return f
    }
    ...
    function A(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            qe.hasData(e) && (a = qe.access(e), l = pe.extend({}, a), qe.set(t, l))
        }
    }
    ...
    function D(e, t, i, r) {
        ...
        if (d && (o = w(t, e[0].ownerDocument, !1, e, r), s = o.firstChild, 1 === o.childNodes.length && (o = s), s || r)) {
            for (l = (a = pe.map(y(o, "script"), j)).length; f < d; f++) c = o, f !== h && (c = pe.clone(c, !0, !0), l && pe.merge(a, y(c, "script"))), i.call(e[f], c, f);
            if (l) for (u = a[a.length - 1].ownerDocument, pe.map(a, S), f = 0; f < l; f++) c = a[f], Qe.test(c.type || "") && !Le.access(c, "globalEval") && pe.contains(u, c) && (c.src ? pe._evalUrl && pe._evalUrl(c.src) : n(c.textContent.replace(it, ""), u))
        }
        return e
    }
    ...
    function $(e, t, n) {
        var i, r, o = 0, s = $.prefilters.length, a = pe.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (r) return !1;
        ...
        for (K(u, c.opts.specialEasing); o < s; o++) if (i = $.prefilters[o].call(c, e, u, c.opts)) return pe.isFunction(i.stop) && (pe._queueHooks(c.elem, c.opts.queue).stop = pe.proxy(i.stop, i)), i;
    ...
    var be = function (e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : M) !== N && D(t), t = t || N, I)) {
        ...
        function y(e, n) {
            var r = n.length > 0, o = e.length > 0, s = function (i, s, a, l, c) {
                var u, f, d, h = 0, p = "0", g = i && [], v = [], y = S, b = i || o && _.find.TAG("*", c),
                    w = F += null == y ? 1 : Math.random() || .1, x = b.length;
                for (c && (S = s === N || s || c); p !== x && null != (u = b[p]); p++) {
                    if (o && u) {
                        for (f = 0, s || u.ownerDocument === N || (D(u), a = !I); d = e[f++];) if (d(u, s || N, a)) {
                            l.push(u);
                            break
                        }
                        c && (F = w)
        ...
        var b, w, _, x, E, T, C, j, S, A, k, D, N, O, I, L, q, P, H, R = "sizzle" + 1 * new Date, M = e.document, F = 0,
            W = 0, U = n(), B = n(), K = n(), $ = function (e, t) {
                return e === t && (k = !0), 0
            }, Q = {}.hasOwnProperty, z = [], X = z.pop, V = z.push, Y = z.push, G = z.slice, J = function (e, t) {
        ...
        w = t.support = {}, E = t.isXML = function (e) {
            ...
            return i !== N && 9 === i.nodeType && i.documentElement ? (N = i, O = N.documentElement, I = !E(N), M !== N && (n = N.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", _e, !1) : n.attachEvent && n.attachEvent("onunload", _e)), w.attributes = r(function (e) {
                return e.className = "i", !e.getAttribute("className")
            }), w.getElementsByTagName = r(function (e) {
                return e.appendChild(N.createComment("")), !e.getElementsByTagName("*").length
            }), w.getElementsByClassName = pe.test(N.getElementsByClassName), w.getById = r(function (e) {
                return O.appendChild(e).id = R, !N.getElementsByName || !N.getElementsByName(R).length
            ...
            }, q = [], L = [], (w.qsa = pe.test(N.querySelectorAll)) && (r(function (e) {
            ...
            })), (w.matchesSelector = pe.test(P = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && r(function (e) {
                w.disconnectedMatch = P.call(e, "*"), P.call(e, "[s!='']:x"), q.push("!=", ie)
            }), L = L.length && new RegExp(L.join("|")), q = q.length && new RegExp(q.join("|")), t = pe.test(O.compareDocumentPosition), H = t || pe.test(O.contains) ? function (e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === N || e.ownerDocument === M && H(M, e) ? -1 : t === N || t.ownerDocument === M && H(M, t) ? 1 : A ? J(A, e) - J(A, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t) return k = !0, 0;
            ...
            if ((e.ownerDocument || e) !== N && D(e), n = n.replace(le, "='$1']"), w.matchesSelector && I && !K[n + " "] && (!q || !q.test(n)) && (!L || !L.test(n))) try {
                var i = P.call(e, n);
            ...
            var t, n = [], i = 0, r = 0;
            if (k = !w.detectDuplicates, A = !w.sortStable && e.slice(0), e.sort($), k) {
        ...
        }, w.sortStable = R.split("").sort($).join("") === R, w.detectDuplicates = !!k, D(), w.sortDetached = r(function (e) {
    ...
    var we = function (e, t, n) {
            ...
            return n
        }, xe = pe.expr.match.needsContext, Ee = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i,
        Te = /^.[^:#\[\.,]*$/;
    pe.filter = function (e, t, n) {
        ...
        find: function (e) {
            ...
            return !!o(this, "string" == typeof e && xe.test(e) ? pe(e) : e || [], !1).length
        }
    });
    var Ce, je = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (pe.fn.init = function (e, t, n) {
        ...
        if (n = n || Ce, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof pe ? t[0] : t, pe.merge(this, pe.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : te, !0)), Ee.test(i[1]) && pe.isPlainObject(t)) for (i in t) pe.isFunction(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
                return this
            }
    ...
    pe.fn.extend({
        has: function (e) {
            ...
            if (!xe.test(e)) for (; i < r; i++) for (n = this[i]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && pe.find.matchesSelector(n, e))) {
                o.push(n);
                break
            }
        ...
        pe.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = pe.filter(i, r)), this.length > 1 && (Ae[e] || pe.uniqueSort(r), Se.test(e) && r.reverse()), this.pushStack(r)
        }
    });
    var ke = /[^\x20\t\r\n\f]+/g;
    ...
    }), pe.ready.then = Ne.then, "complete" === te.readyState || "loading" !== te.readyState && !te.documentElement.doScroll ? e.setTimeout(pe.ready) : (te.addEventListener("DOMContentLoaded", f), e.addEventListener("load", f));
    ...
    d.uid = 1, d.prototype = {
        cache: function (e) {
            ...
            if (void 0 !== i) {
                if (void 0 !== t) {
                    Array.isArray(t) ? t = t.map(pe.camelCase) : (t = pe.camelCase(t), t = t in i ? [t] : t.match(ke) || []), n = t.length;
                    for (; n--;) delete i[t[n]]
                }
    ...
    var Le = new d, qe = new d, Pe = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, He = /[A-Z]/g;
    pe.extend({
        hasData: function (e) {
        ...
        data: function (e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (r = qe.get(o), 1 === o.nodeType && !Le.get(o, "hasDataAttrs"))) {
    ...
    var Ke = /^(?:checkbox|radio)$/i, $e = /<([a-z][^\/\0>\x20\t\r\n\f]+)/i, Qe = /^$|\/(?:java|ecma)script/i, ze = {
    ...
    pe.event = {
        global: {}, add: function (e, t, n, i, r) {
            ...
            }), c = (t = (t || "").match(ke) || [""]).length; c--;) a = Je.exec(t[c]) || [], h = m = a[1], p = (a[2] || "").split(".").sort(), h && (f = pe.event.special[h] || {}, h = (r ? f.delegateType : f.bindType) || h, f = pe.event.special[h] || {}, u = pe.extend({
                type: h,
                origType: m,
                data: i,
                handler: n,
            ...
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(ke) || [""]).length; c--;) if (a = Je.exec(t[c]) || [], h = m = a[1], p = (a[2] || "").split(".").sort(), h) {
        ...
        return this instanceof pe.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? _ : x, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && pe.extend(this, t), this.timeStamp = e && e.timeStamp || pe.now(), void (this[pe.expando] = !0)) : new pe.Event(e, t)
    }, pe.Event.prototype = {
    ...
    pe.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(de.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || pe.isXMLDoc(e))) for (s = y(a), o = y(e), i = 0, r = o.length; i < r; i++) k(o[i], s[i]);
        ...
        detach: function (e) {
            ...
            return Oe(this, function (e) {
                ...
                if ("string" == typeof e && !et.test(e) && !ze[($e.exec(e) || ["", ""])[1].toLowerCase()]) {
    ...
    pe.extend({
        ...
        pe.cssHooks[t] = {
            get: function (e, n, i) {
                ...
                return s && (r = Me.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = pe.css(e, t)), P(0, n, s)
            }
        }
    ...
    pe.fn.extend({
        ...
        addClass: function (e) {
            ...
            if ("string" == typeof e && e) for (t = e.match(ke) || []; n = this[l++];) if (r = z(n), i = 1 === n.nodeType && " " + Q(r) + " ") {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : pe.isFunction(e) ? this.each(function (n) {
                ...
                var t, i, r, o;
                if ("string" === n) for (i = 0, r = pe(this), o = e.match(ke) || []; t = o[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t); else void 0 !== e && "boolean" !== n || ((t = z(this)) && Le.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Le.get(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, i = 0;
    ...
    pe.extend(pe.event, {
        trigger: function (t, n, i, r) {
            ...
            if (s = a = i = i || te, 3 !== i.nodeType && 8 !== i.nodeType && !xt.test(h + pe.event.triggered) && (h.indexOf(".") > -1 && (p = h.split("."), h = p.shift(), p.sort()), c = h.indexOf(":") < 0 && "on" + h, t = t[pe.expando] ? t : new pe.Event(h, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : pe.makeArray(n, [t]), f = pe.event.special[h] || {}, r || !f.trigger || !1 !== f.trigger.apply(i, n))) {
    ...
    var Et = e.location, Tt = pe.now(), Ct = /\?/;
    ...
    pe.param = function (e, t) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !pe(this).is(":disabled") && kt.test(this.nodeName) && !At.test(e) && (this.checked || !Ke.test(e))
            }).map(function (e, t) {
                var n = pe(this).val();
    ...
    var Dt = /%20/g, Nt = /#.*$/, Ot = /([?&])_=[^&]*/, It = /^(.*?):[ \t]*([^\r\n]*)$/gm,
        Lt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, qt = /^(?:GET|HEAD)$/, Pt = /^\/\//, Ht = {},
    ...
    Ft.href = Et.href, pe.extend({
        ...
        ajax: function (t, n) {
            ...
            if (v.promise(E), p.url = ((t || p.url || Et.href) + "").replace(Pt, Et.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(ke) || [""], null == p.crossDomain) {
    ...
    pe.ajaxSetup({
        ...
        if (a || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = pe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Kt, "$1" + r) : !1 !== t.jsonp && (t.url += (Ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function () {
        ...
        var i, r, o;
        return t || (de.createHTMLDocument ? (t = te.implementation.createHTMLDocument(""), i = t.createElement("base"), i.href = te.location.href, t.head.appendChild(i)) : t = te), r = Ee.exec(e), o = !n && [], r ? [t.createElement(r[1])] : (r = w([e], t, o), o && o.length && pe(o).remove(), pe.merge([], r.childNodes))
    }, pe.fn.load = function (e, t, n) {
        var i, r, o, s = this, a = e.indexOf(" ");
        return a > -1 && (i = Q(e.slice(a)), e = e.slice(0, a)), pe.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), s.length > 0 && pe.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
    ...
    return pe.noConflict = function (t) {
        return e.$ === pe && (e.$ = Qt), t && e.jQuery === pe && (e.jQuery = $t), pe
    }, t || (e.jQuery = e.$ = pe), pe
}), function (e, t) {
    ...
    for (var $ = Math.min, Q = Math.floor, z = Math.max, X = ["native code", "[object MutationObserverConstructor]"], V = "undefined" != typeof window, Y = ["Edge", "Trident", "Firefox"], G = 0, J = 0; J < Y.length; J += 1) if (V && 0 <= navigator.userAgent.indexOf(Y[J])) {
        G = 1;
        break
    }
        ...
        placement: "bottom", eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
            ...
            shift: {
                ...
                order: 300, enabled: !0, fn: function (e, t) {
                    ...
                    var o = t.priority, s = e.offsets.popper, a = {
                        primary: function (e) {
                            ...
                            return s[e] > i[e] && !t.escapeWithReference && (r = $(s[n], i[e] - ("right" === e ? s.width : s.height))), re({}, n, r)
                        }
                    };
                ...
                order: 400, enabled: !0, fn: function (e) {
                    var t = e.offsets, n = t.popper, i = t.reference, r = e.placement.split("-")[0], o = Q,
                ...
                order: 500, enabled: !0, fn: function (e, n) {
                    ...
                    var r = e.placement.split("-")[0], o = e.offsets, s = o.popper, a = o.reference,
                        ...
                        f = u.toLowerCase(), d = l ? "left" : "top", p = l ? "bottom" : "right", m = x(i)[c];
                    ...
                    return y = z($(s[c] - m, y), 0), e.arrowElement = i, e.offsets.arrow = {}, e.offsets.arrow[f] = Math.round(y), e.offsets.arrow[d] = "", e
                }, element: "[x-arrow]"
            }, flip: {
                order: 600, enabled: !0, fn: function (e, t) {
                    ...
                    return s.forEach(function (a, l) {
                        ...
                        var c = e.offsets.popper, u = e.offsets.reference, f = Q,
                ...
                order: 850, enabled: !0, fn: function (e, t) {
                    ...
                    var a, l, c = void 0 === s ? t.gpuAcceleration : s, u = p(r(e.instance.popper)),
                        ...
                        d = {left: Q(o.left), top: Q(o.top), bottom: Q(o.bottom), right: Q(o.right)},
                        h = "bottom" === n ? "top" : "bottom", m = "right" === i ? "left" : "right", g = D("transform");
    ...
    var s, a, l, c, u, f, d, h, p, m, g, v, y, b, w, _, x, E, T, C, j, S, A, k, D, N, O, I, L, q, P, H, R, M, F, W, U,
        B, K, $, Q, z, X, V, Y, G, J, Z, ee, te, ne, ie, re, oe, se, ae, le, ce, ue, fe, de, he, pe, me, ge, ve, ye, be,
        we, _e, xe, Ee, Te, Ce, je, Se, Ae, ke, De, Ne, Oe, Ie, Le, qe, Pe, He, Re, Me, Fe, We, Ue, Be, Ke, $e, Qe, ze,
        Xe, Ve, Ye, Ge, Je, Ze, et, tt, nt, it, rt, ot, st, at, lt, ct, ut, ft, dt, ht, pt, mt, gt, vt, yt, bt, wt, _t,
        xt, Et, Tt, Ct, jt, St, At, kt, Dt, Nt, Ot, It, Lt, qt, Pt, Ht, Rt, Mt, Ft, Wt, Ut, Bt, Kt, $t, Qt, zt, Xt, Vt,
        Yt, Gt, Jt, Zt, en, tn, nn, rn, on, sn, an, ln, cn, un, fn, dn, hn, pn, mn, gn, vn, yn, bn, wn, _n, xn, En, Tn,
        Cn, jn, Sn, An, kn, Dn, Nn, On, In, Ln, qn, Pn, Hn, Rn, Mn, Fn, Wn = function (e) {
        ...
        }(t), Un = (a = "alert", c = "." + (l = "bs.alert"), u = (s = t).fn[a], f = {
            CLOSE: "close" + c,
            CLOSED: "closed" + c,
            CLICK_DATA_API: "click" + c + ".data-api"
        }, d = "alert", h = "fade", p = "show", m = function () {
            function e(e) {
                this._element = e
            }
            ...
            return t.close = function (e) {
                ...
                var t = Wn.getSelectorFromElement(e), n = !1;
        ...
        }(), s(document).on(f.CLICK_DATA_API, '[data-dismiss="alert"]', m._handleDismiss(new m)), s.fn[a] = m._jQueryInterface, s.fn[a].Constructor = m, s.fn[a].noConflict = function () {
            return s.fn[a] = u, m._jQueryInterface
        }, m),
        Bn = (v = "button", b = "." + (y = "bs.button"), w = ".data-api", _ = (g = t).fn[v], x = "active", E = "btn", C = '[data-toggle^="button"]', j = '[data-toggle="buttons"]', S = "input", A = ".active", k = ".btn", D = {
            ...
            return t.toggle = function () {
                var e = !0, t = !0, n = g(this._element).closest(j)[0];
                if (n) {
                    ...
                    if (i) {
                        ...
                        if (e) {
                            ...
                            i.checked = !this._element.classList.contains(x), g(i).trigger("change")
                        }
                        i.focus(), t = !1
                    }
                }
                t && this._element.setAttribute("aria-pressed", !this._element.classList.contains(x)), e && g(this._element).toggleClass(x)
            }, t.dispose = function () {
        ...
        }(), g(document).on(D.CLICK_DATA_API, C, function (e) {
            e.preventDefault();
            var t = e.target;
            g(t).hasClass("btn") || (t = g(t).closest(k)), N._jQueryInterface.call(g(t), "toggle")
        ...
        }, N), Kn = (I = "carousel", q = "." + (L = "bs.carousel"), P = ".data-api", H = (O = t).fn[I], R = {
            interval: 5e3,
            keyboard: !0,
            slide: !1,
            pause: "hover",
            ...
            wrap: "boolean"
        }, F = "next", W = "prev", U = "left", B = "right", K = {
            SLIDE: "slide" + q,
            SLID: "slid" + q,
            KEYDOWN: "keydown" + q,
        ...
        }, $ = "carousel", Q = "active", z = "slide", X = "carousel-item-right", V = "carousel-item-left", Y = "carousel-item-next", G = "carousel-item-prev", J = ".active", Z = ".active.carousel-item", ee = ".carousel-item", te = ".carousel-item-next, .carousel-item-prev", ne = ".carousel-indicators", ie = "[data-slide], [data-slide-to]", re = '[data-ride="carousel"]', oe = function () {
            function e(e, t) {
            ...
            return t.next = function () {
                ...
                e || (this._isPaused = !0), this._element.querySelector(te) && (Wn.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
            }, t.cycle = function (e) {
                ...
                if (!(e > this._items.length - 1 || e < 0)) if (this._isSliding) O(this._element).one(K.SLID, function () {
                    return t.to(e)
                }); else {
                ...
                O(this._element).off(q), O.removeData(this._element, L), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, t._getConfig = function (e) {
                return e = o({}, R, e), Wn.typeCheckConfig(I, e, M), e
            }, t._addEventListeners = function () {
                var e = this;
                this._config.keyboard && O(this._element).on(K.KEYDOWN, function (t) {
                    return e._keydown(t)
                }), "hover" === this._config.pause && (O(this._element).on(K.MOUSEENTER, function (t) {
                    return e.pause(t)
                ...
                var n = e === F, i = e === W, r = this._getItemIndex(t), o = this._items.length - 1;
                ...
                var n = this._getItemIndex(e), i = this._getItemIndex(this._element.querySelector(Z)),
                    r = O.Event(K.SLIDE, {relatedTarget: e, direction: t, from: i, to: n});
                ...
                if (e === F ? (n = V, i = Y, r = U) : (n = X, i = G, r = B), l && O(l).hasClass(Q)) this._isSliding = !1; else if (!this._triggerSlideEvent(l, r).isDefaultPrevented() && s && l) {
                    this._isSliding = !0, u && this.pause(), this._setActiveIndicatorElement(l);
                    var f = O.Event(K.SLID, {relatedTarget: l, direction: r, from: a, to: c});
                    if (O(this._element).hasClass(z)) {
                        O(l).addClass(i), Wn.reflow(l), O(s).addClass(n), O(l).addClass(n);
                ...
                return this.each(function () {
                    var n = O(this).data(L), i = o({}, R, O(this).data());
                    "object" == typeof t && (i = o({}, i, t));
                    var r = "string" == typeof t ? t : i.slide;
                    if (n || (n = new e(this, i), O(this).data(L, n)), "number" == typeof t) n.to(t); else if ("string" == typeof r) {
                ...
                if (n) {
                    var i = O(n)[0];
                    if (i && O(i).hasClass($)) {
                        var r = o({}, O(i).data(), O(this).data()), s = this.getAttribute("data-slide-to");
        ...
        }), O.fn[I] = oe._jQueryInterface, O.fn[I].Constructor = oe, O.fn[I].noConflict = function () {
            return O.fn[I] = H, oe._jQueryInterface
        }, oe), $n = (ae = "collapse", ce = "." + (le = "bs.collapse"), ue = (se = t).fn[ae], fe = {
            toggle: !0,
            parent: ""
        }, de = {toggle: "boolean", parent: "(string|element)"}, he = {
            SHOW: "show" + ce,
            SHOWN: "shown" + ce,
            HIDE: "hide" + ce,
            HIDDEN: "hidden" + ce,
            CLICK_DATA_API: "click" + ce + ".data-api"
        }, pe = "show", me = "collapse", ge = "collapsing", ve = "collapsed", ye = "width", be = "height", we = ".show, .collapsing", _e = '[data-toggle="collapse"]', xe = function () {
            function e(e, t) {
                ...
                for (var n = [].slice.call(document.querySelectorAll(_e)), i = 0, r = n.length; i < r; i++) {
                    var o = n[i], s = Wn.getSelectorFromElement(o),
            ...
            return t.toggle = function () {
                ...
                var t, n, i = this;
                if (!(this._isTransitioning || se(this._element).hasClass(pe) || (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(we)).filter(function (e) {
                    ...
                    if (se(this._element).trigger(r), !r.isDefaultPrevented()) {
                        ...
                        se(this._element).one(Wn.TRANSITION_END, function () {
                            se(i._element).removeClass(ge).addClass(me).addClass(pe), i._element.style[o] = "", i.setTransitioning(!1), se(i._element).trigger(he.SHOWN)
                ...
                if (!this._isTransitioning && se(this._element).hasClass(pe)) {
                    ...
                    if (se(this._element).trigger(t), !t.isDefaultPrevented()) {
                        ...
                        this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", Wn.reflow(this._element), se(this._element).addClass(ge).removeClass(me).removeClass(pe);
                        var i = this._triggerArray.length;
                        if (0 < i) for (var r = 0; r < i; r++) {
                            var o = this._triggerArray[r], s = Wn.getSelectorFromElement(o);
                        ...
                        se(this._element).one(Wn.TRANSITION_END, function () {
                            e.setTransitioning(!1), se(e._element).removeClass(ge).addClass(me).trigger(he.HIDDEN)
                ...
                return (e = o({}, fe, e)).toggle = Boolean(e.toggle), Wn.typeCheckConfig(ae, e, de), e
            }, t._getDimension = function () {
                return se(this._element).hasClass(ye) ? ye : "height"
            }, t._getParent = function () {
                var t = this, n = null;
                Wn.isElement(this._config.parent) ? (n = this._config.parent, void 0 !== this._config.parent.jquery && (n = this._config.parent[0])) : n = document.querySelector(this._config.parent);
                ...
                return this.each(function () {
                    var n = se(this), i = n.data(le), r = o({}, fe, n.data(), "object" == typeof t && t ? t : {});
            ...
            var t = se(this), n = Wn.getSelectorFromElement(this), i = [].slice.call(document.querySelectorAll(n));
            se(i).each(function () {
                var e = se(this), n = e.data(le) ? "toggle" : t.data();
                xe._jQueryInterface.call(e, n)
            })
        }), se.fn[ae] = xe._jQueryInterface, se.fn[ae].Constructor = xe, se.fn[ae].noConflict = function () {
            return se.fn[ae] = ue, xe._jQueryInterface
        }, xe),
        Qn = (Te = "dropdown", je = "." + (Ce = "bs.dropdown"), Se = ".data-api", Ae = (Ee = t).fn[Te], ke = new RegExp("38|40|27"), De = {
            HIDE: "hide" + je,
            HIDDEN: "hidden" + je,
            SHOW: "show" + je,
            SHOWN: "shown" + je,
        ...
        }, Ne = "disabled", Oe = "show", Ie = "dropup", Le = "dropright", qe = "dropleft", Pe = "dropdown-menu-right", He = "position-static", Re = '[data-toggle="dropdown"]', Me = ".dropdown form", Fe = ".dropdown-menu", We = ".navbar-nav", Ue = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", Be = "top-start", Ke = "top-end", $e = "bottom-start", Qe = "bottom-end", ze = "right-start", Xe = "left-start", Ve = {
            offset: 0,
            flip: !0,
            ...
            return t.toggle = function () {
                if (!this._element.disabled && !Ee(this._element).hasClass(Ne)) {
                    var t = e._getParentFromElement(this._element), i = Ee(this._menu).hasClass(Oe);
                    if (e._clearMenus(), !i) {
                        var r = {relatedTarget: this._element}, o = Ee.Event(De.SHOW, r);
                        if (Ee(t).trigger(o), !o.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                if (void 0 === n) throw new TypeError("Bootstrap dropdown require Popper.js (https://popper.js.org)");
                                var s = this._element;
                                "parent" === this._config.reference ? s = t : Wn.isElement(this._config.reference) && (s = this._config.reference, void 0 !== this._config.reference.jquery && (s = this._config.reference[0])), "scrollParent" !== this._config.boundary && Ee(t).addClass(He), this._popper = new n(s, this._menu, this._getPopperConfig())
                            }
                            "ontouchstart" in document.documentElement && 0 === Ee(t).closest(We).length && Ee(document.body).children().on("mouseover", null, Ee.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), Ee(this._menu).toggleClass(Oe), Ee(t).toggleClass(Oe).trigger(Ee.Event(De.SHOWN, r))
                        }
                    }
                }
            }, t.dispose = function () {
                Ee.removeData(this._element, Ce), Ee(this._element).off(je), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
            }, t.update = function () {
                ...
                return e = o({}, this.constructor.Default, Ee(this._element).data(), e), Wn.typeCheckConfig(Te, e, this.constructor.DefaultType), e
                ...
                var e = Ee(this._element.parentNode), t = $e;
                return e.hasClass("dropup") ? (t = Be, Ee(this._menu).hasClass(Pe) && (t = Ke)) : e.hasClass(Le) ? t = ze : e.hasClass(qe) ? t = Xe : Ee(this._menu).hasClass(Pe) && (t = Qe), t
                ...
                return this.each(function () {
                    ...
                    if (n || (n = new e(this, "object" == typeof t ? t : null), Ee(this).data(Ce, n)), "string" == typeof t) {
                        if (void 0 === n[t]) throw new TypeError('No method named "' + t + '"');
                        n[t]()
                    }
                })
            }, e._clearMenus = function (t) {
                if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which)) for (var n = [].slice.call(document.querySelectorAll(Re)), i = 0, r = n.length; i < r; i++) {
                    var o = e._getParentFromElement(n[i]), s = Ee(n[i]).data(Ce), a = {relatedTarget: n[i]};
                    if (t && "click" === t.type && (a.clickEvent = t), s) {
                        var l = s._menu;
                        if (Ee(o).hasClass(Oe) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && Ee.contains(o, t.target))) {
                            var c = Ee.Event(De.HIDE, a);
                            Ee(o).trigger(c), c.isDefaultPrevented() || ("ontouchstart" in document.documentElement && Ee(document.body).children().off("mouseover", null, Ee.noop), n[i].setAttribute("aria-expanded", "false"), Ee(l).removeClass(Oe), Ee(o).removeClass(Oe).trigger(Ee.Event(De.HIDDEN, a)))
                        }
                    }
                }
                ...
                if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || Ee(t.target).closest(Fe).length)) : ke.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !Ee(this).hasClass(Ne))) {
                    var n = e._getParentFromElement(this), i = Ee(n).hasClass(Oe);
        ...
        }(), Ee(document).on(De.KEYDOWN_DATA_API, Re, Ge._dataApiKeydownHandler).on(De.KEYDOWN_DATA_API, Fe, Ge._dataApiKeydownHandler).on(De.CLICK_DATA_API + " " + De.KEYUP_DATA_API, Ge._clearMenus).on(De.CLICK_DATA_API, Re, function (e) {
            e.preventDefault(), e.stopPropagation(), Ge._jQueryInterface.call(Ee(this), "toggle")
        ...
        }, Ge), zn = (Ze = "modal", tt = "." + (et = "bs.modal"), nt = (Je = t).fn[Ze], it = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
            show: !0
        ...
        }, st = "modal-scrollbar-measure", at = "modal-backdrop", lt = "modal-open", ct = "fade", ut = "show", ft = ".modal-dialog", dt = '[data-toggle="modal"]', ht = '[data-dismiss="modal"]', pt = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", mt = ".sticky-top", gt = function () {
            function e(e, t) {
                this._config = this._getConfig(t), this._element = e, this._dialog = e.querySelector(ft), this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._scrollbarWidth = 0
            }
            ...
            return t.toggle = function (e) {
                ...
                if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
                    ...
                    if (Je(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                        ...
                        if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), Je(document).off(ot.FOCUSIN), Je(this._element).removeClass(ut), Je(this._element).off(ot.CLICK_DISMISS), Je(this._dialog).off(ot.MOUSEDOWN_DISMISS), i) {
                            var r = Wn.getTransitionDurationFromElement(this._element);
                            Je(this._element).one(Wn.TRANSITION_END, function (e) {
                ...
                var t = this, n = Je(this._element).hasClass(ct);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, n && Wn.reflow(this._element), Je(this._element).addClass(ut), this._config.focus && this._enforceFocus();
                var i = Je.Event(ot.SHOWN, {relatedTarget: e}), r = function () {
                ...
                if (n) {
                    ...
                    Je(this._dialog).one(Wn.TRANSITION_END, r).emulateTransitionEnd(o)
                } else r()
            }, t._enforceFocus = function () {
                var e = this;
                Je(document).off(ot.FOCUSIN).on(ot.FOCUSIN, function (t) {
                    document !== t.target && e._element !== t.target && 0 === Je(e._element).has(t.target).length && e._element.focus()
                })
            }, t._setEscapeEvent = function () {
                var e = this;
                this._isShown && this._config.keyboard ? Je(this._element).on(ot.KEYDOWN_DISMISS, function (t) {
                    27 === t.which && (t.preventDefault(), e.hide())
                }) : this._isShown || Je(this._element).off(ot.KEYDOWN_DISMISS)
            }, t._setResizeEvent = function () {
                var e = this;
                this._isShown ? Je(window).on(ot.RESIZE, function (t) {
                ...
                var t = this, n = Je(this._element).hasClass(ct) ? ct : "";
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = at, n && this._backdrop.classList.add(n), Je(this._backdrop).appendTo(document.body), Je(this._element).on(ot.CLICK_DISMISS, function (e) {
                        t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === t._config.backdrop ? t._element.focus() : t.hide())
                    }), n && Wn.reflow(this._backdrop), Je(this._backdrop).addClass(ut), !e) return;
                    if (!n) return void e();
                    var i = Wn.getTransitionDurationFromElement(this._backdrop);
                    Je(this._backdrop).one(Wn.TRANSITION_END, e).emulateTransitionEnd(i)
                    ...
                    if (Je(this._element).hasClass(ct)) {
                        ...
                        Je(this._backdrop).one(Wn.TRANSITION_END, r).emulateTransitionEnd(o)
                    } else r()
                } else e && e()
                ...
                if (this._isBodyOverflowing) {
                    var t = [].slice.call(document.querySelectorAll(pt)), n = [].slice.call(document.querySelectorAll(mt));
                    Je(t).each(function (t, n) {
                        var i = n.style.paddingRight, r = Je(n).css("padding-right");
                        Je(n).data("padding-right", i).css("padding-right", parseFloat(r) + e._scrollbarWidth + "px")
                    }), Je(n).each(function (t, n) {
                        var i = n.style.marginRight, r = Je(n).css("margin-right");
                        Je(n).data("margin-right", i).css("margin-right", parseFloat(r) - e._scrollbarWidth + "px")
                    });
                    var i = document.body.style.paddingRight, r = Je(document.body).css("padding-right");
                    Je(document.body).data("padding-right", i).css("padding-right", parseFloat(r) + this._scrollbarWidth + "px")
                }
            }, t._resetScrollbar = function () {
                var e = [].slice.call(document.querySelectorAll(pt));
                Je(e).each(function (e, t) {
                    var n = Je(t).data("padding-right");
                    Je(t).removeData("padding-right"), t.style.paddingRight = n || ""
                });
                ...
                Je(document.body).removeData("padding-right"), document.body.style.paddingRight = n || ""
                ...
                return this.each(function () {
                    var i = Je(this).data(et), r = o({}, it, Je(this).data(), "object" == typeof t && t ? t : {});
                    if (i || (i = new e(this, r), Je(this).data(et, i)), "string" == typeof t) {
                        if (void 0 === i[t]) throw new TypeError('No method named "' + t + '"');
                        i[t](n)
            ...
            var t, n = this, i = Wn.getSelectorFromElement(this);
            i && (t = document.querySelector(i));
            var r = Je(t).data(et) ? "toggle" : o({}, Je(t).data(), Je(this).data());
        ...
        }), Je.fn[Ze] = gt._jQueryInterface, Je.fn[Ze].Constructor = gt, Je.fn[Ze].noConflict = function () {
            return Je.fn[Ze] = nt, gt._jQueryInterface
        }, gt),
        Xn = (yt = "tooltip", wt = "." + (bt = "bs.tooltip"), _t = (vt = t).fn[yt], xt = "bs-tooltip", Et = new RegExp("(^|\\s)" + xt + "\\S+", "g"), jt = {
            animation: !0,
            template: '<div class="tooltip" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>',
            trigger: "hover focus",
            title: "",
            delay: 0,
            html: !(Ct = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}),
            selector: !(Tt = {
                animation: "boolean",
                template: "string",
        ...
        }, Dt = "fade", Nt = "show", Ot = ".tooltip-inner", It = ".arrow", Lt = "hover", qt = "focus", Pt = "click", Ht = "manual", Rt = function () {
            function e(e, t) {
            ...
            return t.enable = function () {
                ...
                if (this._isEnabled) if (e) {
                    var t = this.constructor.DATA_KEY, n = vt(e.currentTarget).data(t);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var r = this.getTipElement(), o = Wn.getUID(this.constructor.NAME);
                    r.setAttribute("id", o), this.element.setAttribute("aria-describedby", o), this.setContent(), this.config.animation && vt(r).addClass(Dt);
                    ...
                    var c = function () {
                        ...
                        var t = e._hoverState;
                        e._hoverState = null, vt(e.element).trigger(e.constructor.Event.SHOWN), t === At && e._leave(null, e)
                    };
                    if (vt(this.tip).hasClass(Dt)) {
                        var u = Wn.getTransitionDurationFromElement(this.tip);
                        vt(this.tip).one(Wn.TRANSITION_END, c).emulateTransitionEnd(u)
                    } else c()
                }
            }, t.hide = function (e) {
                var t = this, n = this.getTipElement(), i = vt.Event(this.constructor.Event.HIDE), r = function () {
                    t._hoverState !== St && n.parentNode && n.parentNode.removeChild(n), t._cleanTipClass(), t.element.removeAttribute("aria-describedby"), vt(t.element).trigger(t.constructor.Event.HIDDEN), null !== t._popper && t._popper.destroy(), e && e()
                };
                if (vt(this.element).trigger(i), !i.isDefaultPrevented()) {
                    if (vt(n).removeClass(Nt), "ontouchstart" in document.documentElement && vt(document.body).children().off("mouseover", null, vt.noop), this._activeTrigger.click = !1, this._activeTrigger[qt] = !1, this._activeTrigger[Lt] = !1, vt(this.tip).hasClass(Dt)) {
                ...
                this.setElementContent(vt(e.querySelectorAll(Ot)), this.getTitle()), vt(e).removeClass(Dt + " " + Nt)
                ...
                this.config.trigger.split(" ").forEach(function (t) {
                    if ("click" === t) vt(e.element).on(e.constructor.Event.CLICK, e.config.selector, function (t) {
                        ...
                        var n = t === Lt ? e.constructor.Event.MOUSEENTER : e.constructor.Event.FOCUSIN,
                            i = t === Lt ? e.constructor.Event.MOUSELEAVE : e.constructor.Event.FOCUSOUT;
                ...
                var n = this.constructor.DATA_KEY;
                (t = t || vt(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), vt(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusout" === e.type ? qt : Lt] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = At, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function () {
                ...
                return "number" == typeof (e = o({}, this.constructor.Default, vt(this.element).data(), "object" == typeof e && e ? e : {})).delay && (e.delay = {
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), Wn.typeCheckConfig(yt, e, this.constructor.DefaultType), e
            }, t._getDelegateConfig = function () {
                var e = {};
                if (this.config) for (var t in this.config) this.constructor.Default[t] !== this.config[t] && (e[t] = this.config[t]);
                return e
            }, t._cleanTipClass = function () {
                var e = vt(this.getTipElement()), t = e.attr("class").match(Et);
                ...
                null === e.getAttribute("x-placement") && (vt(e).removeClass(Dt), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
            }, e._jQueryInterface = function (t) {
                return this.each(function () {
                    var n = vt(this).data(bt), i = "object" == typeof t && t;
        ...
        }(), vt.fn[yt] = Rt._jQueryInterface, vt.fn[yt].Constructor = Rt, vt.fn[yt].noConflict = function () {
            return vt.fn[yt] = _t, Rt._jQueryInterface
        }, Rt),
        Vn = (Ft = "popover", Ut = "." + (Wt = "bs.popover"), Bt = (Mt = t).fn[Ft], Kt = "bs-popover", $t = new RegExp("(^|\\s)" + Kt + "\\S+", "g"), Qt = o({}, Xn.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        }), zt = o({}, Xn.DefaultType, {content: "(string|element|function)"}), Xt = "fade", Yt = ".popover-header", Gt = ".popover-body", Jt = {
            HIDE: "hide" + Ut,
            HIDDEN: "hidden" + Ut,
            SHOW: (Vt = "show") + Ut,
            SHOWN: "shown" + Ut,
            ...
            return o.isWithContent = function () {
                ...
                "function" == typeof t && (t = t.call(this.element)), this.setElementContent(e.find(Gt), t), e.removeClass("fade show")
            }, o._getContent = function () {
                return this.element.getAttribute("data-content") || this.config.content
            }, o._cleanTipClass = function () {
                var e = Mt(this.getTipElement()), t = e.attr("class").match($t);
                null !== t && 0 < t.length && e.removeClass(t.join(""))
            }, t._jQueryInterface = function (e) {
                return this.each(function () {
                    var n = Mt(this).data(Wt), i = "object" == typeof e ? e : null;
                    if ((n || !/destroy|hide/.test(e)) && (n || (n = new t(this, i), Mt(this).data(Wt, n)), "string" == typeof e)) {
        ...
        }(Xn), Mt.fn[Ft] = Zt._jQueryInterface, Mt.fn[Ft].Constructor = Zt, Mt.fn[Ft].noConflict = function () {
            return Mt.fn[Ft] = Bt, Zt._jQueryInterface
        }, Zt), Yn = (tn = "scrollspy", rn = "." + (nn = "bs.scrollspy"), on = (en = t).fn[tn], sn = {
            offset: 10,
            method: "auto",
            target: ""
        ...
        }, cn = "dropdown-item", un = "active", fn = '[data-spy="scroll"]', dn = ".active", hn = ".nav, .list-group", pn = ".nav-link", mn = ".nav-item", gn = ".list-group-item", vn = ".dropdown", yn = ".dropdown-item", bn = ".dropdown-toggle", wn = "offset", _n = "position", xn = function () {
            function e(e, t) {
                var n = this;
            ...
            return t.refresh = function () {
                var e = this, t = this._scrollElement === this._scrollElement.window ? "offset" : _n,
                    n = "auto" === this._config.method ? t : this._config.method, i = n === _n ? this._getScrollTop() : 0;
                ...
                if ("string" != typeof (e = o({}, sn, "object" == typeof e && e ? e : {})).target) {
                    ...
                    t || (t = Wn.getUID(tn), en(e.target).attr("id", t)), e.target = "#" + t
                }
                ...
                n.hasClass(cn) ? (n.closest(vn).find(bn).addClass(un), n.addClass(un)) : (n.addClass(un), n.parents(hn).prev(pn + ", " + gn).addClass(un), n.parents(hn).prev(mn).children(pn).addClass(un)), en(this._scrollElement).trigger(ln.ACTIVATE, {relatedTarget: e})
            }, t._clear = function () {
                ...
                return this.each(function () {
                    ...
                    if (n || (n = new e(this, "object" == typeof t && t), en(this).data(nn, n)), "string" == typeof t) {
                        if (void 0 === n[t]) throw new TypeError('No method named "' + t + '"');
                        n[t]()
                    }
                })
        ...
        }, xn), Gn = (Cn = "." + (Tn = "bs.tab"), jn = (En = t).fn.tab, Sn = {
            HIDE: "hide" + Cn,
            HIDDEN: "hidden" + Cn,
            SHOW: "show" + Cn,
            SHOWN: "shown" + Cn,
            CLICK_DATA_API: "click" + Cn + ".data-api"
        }, An = "dropdown-menu", kn = "active", Dn = "disabled", Nn = "fade", On = "show", In = ".dropdown", Ln = ".nav, .list-group", qn = ".active", Pn = "> li > .active", Hn = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', Rn = ".dropdown-toggle", Mn = "> .dropdown-menu .active", Fn = function () {
            function e(e) {
                this._element = e
            }
            ...
            return t.show = function () {
                var e = this;
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && En(this._element).hasClass(kn) || En(this._element).hasClass(Dn))) {
                    var t, n, i = En(this._element).closest(Ln)[0], r = Wn.getSelectorFromElement(this._element);
                    if (i) {
                        var o = "UL" === i.nodeName ? Pn : qn;
                        n = (n = En.makeArray(En(i).find(o)))[n.length - 1]
                    }
                    var s = En.Event(Sn.HIDE, {relatedTarget: this._element}), a = En.Event(Sn.SHOW, {relatedTarget: n});
                    if (n && En(n).trigger(s), En(this._element).trigger(a), !a.isDefaultPrevented() && !s.isDefaultPrevented()) {
                ...
                var i = this, r = ("UL" === t.nodeName ? En(t).find(Pn) : En(t).children(qn))[0],
                    o = n && r && En(r).hasClass("fade"), s = function () {
                ...
                if (t) {
                    ...
                    i && En(i).removeClass(kn), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
                }
                if (En(e).addClass(kn), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), Wn.reflow(e), En(e).addClass(On), e.parentNode && En(e.parentNode).hasClass(An)) {
    ...
    }(t), e.Util = Wn, e.Alert = Un, e.Button = Bn, e.Carousel = Kn, e.Collapse = $n, e.Dropdown = Qn, e.Modal = zn, e.Popover = Vn, e.Scrollspy = Yn, e.Tab = Gn, e.Tooltip = Xn, Object.defineProperty(e, "__esModule", {value: !0})
}), function () {
    var e, t, n, i, r, o, s, a, l, c, u, f, d, h, p, m, g, v, y, b, w, _, x, E, T, C, j, S, A, k, D, N, O, I, L, q, P,
        H, R, M, F, W, U, B, K, $, Q, z, X, V = [].slice, Y = {}.hasOwnProperty, G = function (e, t) {
            function n() {
                this.constructor = e
            }
    ...
    }(), c = window.Pace || {}, window.Pace = c, _(c, s.prototype), k = c.options = _({}, w, window.paceOptions, E()), U = 0, K = (Q = ["ajax", "document", "eventLag", "elements"]).length; K > U; U++) P = Q[U], !0 === k[P] && (k[P] = w[P]);
    l = function (e) {
        function t() {
        ...
        var e, t, n;
        return t = arguments[0], e = 2 <= arguments.length ? V.call(arguments, 1) : [], j.unshift("ignore"), n = t.apply(null, e), j.shift(), n
    }, c.track = function () {
        var e, t, n;
        return t = arguments[0], e = 2 <= arguments.length ? V.call(arguments, 1) : [], j.unshift("track"), n = t.apply(null, e), j.shift(), n
    }, q = function (e) {
        var t;
        if (null == e && (e = "GET"), "track" === j[0]) return "force";
        if (!j.length && k.ajax) {
            if ("socket" === e && k.ajax.trackWebSockets) return !0;
            if (t = e.toUpperCase(), J.call(k.ajax.trackMethods, t) >= 0) return !0
        }
        return !1
    }, u = function (e) {
        function t() {
            ...
            t.__super__.constructor.apply(this, arguments), e = function (e) {
                ...
                return t = e.open, e.open = function (i, r) {
                    return q(i) && n.trigger("request", {type: i, url: r, request: e}), t.apply(e, arguments)
                }
            ...
            if (null != M && k.ajax.trackWebSockets) {
                window.WebSocket = function (e, t) {
                    var i;
                    return i = null != t ? new M(e, t) : new M(e), q("socket") && n.trigger("request", {
                        type: "socket",
                        url: e,
                        protocols: t,
                        request: i
        ...
        var t, n, i, r;
        for (n = 0, i = (r = k.ajax.ignoreURLs).length; i > n; n++) if ("string" == typeof (t = r[n])) {
        ...
        var n, i, r, o, s;
        return o = t.type, r = t.request, s = t.url, L(s) ? void 0 : c.running || !1 === k.restartOnRequestAfter && "force" !== q(o) ? void 0 : (i = arguments, "boolean" == typeof (n = k.restartOnRequestAfter || 0) && (n = 0), setTimeout(function () {
            var t, n, s, a, l;
        ...
        return function () {
            ...
            this.progress = 0, e = 0, r = [], i = 0, n = A(), t = setInterval(function () {
                var s;
                return s = A() - n - 50, n = A(), r.push(s), r.length > k.eventLag.sampleCount && r.shift(), e = g(r), ++i >= k.eventLag.minSamples && e < k.eventLag.lagThreshold ? (o.progress = 100, clearInterval(t)) : o.progress = 3 / (e + 3) * 100
            }, 50)
        }
    }(), d = function () {
        function e(e) {
            this.source = e, this.last = this.sinceLastUpdate = 0, this.rate = k.initialRate, this.catchup = 0, this.progress = this.lastProgress = 0, null != this.source && (this.progress = N(this.source, "progress"))
        }

        return e.prototype.tick = function (e, t) {
            var n;
            return null == t && (t = N(this.source, "progress")), t >= 100 && (this.done = !0), t === this.last ? this.sinceLastUpdate += e : (this.sinceLastUpdate && (this.rate = (t - this.last) / this.sinceLastUpdate), this.catchup = (t - this.progress) / k.catchupTime, this.sinceLastUpdate = 0, this.last = t), t > this.progress && (this.progress += this.catchup * e), n = 1 - Math.pow(this.progress / 100, k.easeFactor), this.progress += n * this.rate * e, this.progress = Math.min(this.lastProgress + k.maxProgressPerFrame, this.progress), this.progress = Math.max(0, this.progress), this.progress = Math.min(100, this.progress), this.lastProgress = this.progress, this.progress
        }, e
        ...
        var e, n, i, r, o, s, a, l;
        for (c.sources = H = [], n = 0, r = (s = ["ajax", "elements", "document", "eventLag"]).length; r > n; n++) e = s[n], !1 !== k[e] && H.push(new f[e](k[e]));
        for (i = 0, o = (l = null != (a = k.extraSources) ? a : []).length; o > i; i++) P = l[i], H.push(new P(k));
        ...
        return c.running = !0, v.render(), e = A(), y = !1, m = O(function (t, n) {
            ...
            for (100 - v.progress, r = p = 0, o = !0, l = m = 0, b = H.length; b > m; l = ++m) for (P = H[l], h = null != I[l] ? I[l] : I[l] = [], a = null != (_ = P.elements) ? _ : [P], u = g = 0, w = a.length; w > g; u = ++g) s = a[u], f = null != h[u] ? h[u] : h[u] = new d(s), o &= f.done, f.done || (r++, p += f.tick(t));
            ...
            }, Math.max(k.ghostTime, Math.max(k.minTime - (A() - e), 0)))) : n()
        })
    }, c.start = function (e) {
        _(k, e), c.running = !0;
        try {
                ...
                d = e("./lib/util/extend.js"), h = e("./lib/util/noop"), p = function (e) {
                    this.state = {
                        ...
                        if (e.state) {
                            ...
                            t.url = e.state.url, t.title = e.state.title, t.history = !1, t.scrollPos = e.state.scrollPos, e.state.uid < this.lastUid ? t.backward = !0 : t.forward = !0, this.lastUid = e.state.uid, /*this.loadUrl(e.state.url, t)*/ false
                        }
                    }.bind(this))
                };
...
var MODULE_CONFIG = {
    ...
    screenfull: ["../libs/screenfull/dist/screenfull.js", "../assets/js/plugins/screenfull.js"],
    ...
    chartjs: ["../libs/moment/min/moment-with-locales.min.js", "../libs/chart.js/dist/Chart.min.js", "../assets/js/plugins/jquery.chartjs.js", "../assets/js/plugins/chartjs.js"],
    ...
    fullCalendar: ["../libs/moment/min/moment-with-locales.min.js", "../libs/fullcalendar/dist/fullcalendar.min.js", "../libs/fullcalendar/dist/fullcalendar.min.css", "../assets/js/app/calendar.js"],
...
!function (e, t) {
    ...
    $.fn.plugin = function () {
        ...
        return this.each(function () {
            var e = $(this), t = e.attr("data-option") || e.attr("data-plugin-option"), n = e.attr("data-plugin");
            e[n] && t ? e[n].apply(e, getOpts(t, n)) : lazyload.load(MODULE_CONFIG[n]).then(function () {
                t && e[n].apply(e, getOpts(t, n)), e[n] && e[n].init && e[n].init(), window[n] && window[n].init && window[n].init()
    ...
    var r = function () {
        ...
        t.length > 0 && (t = t[t.length - 1]), e("[data-nav] li.active").removeClass("active"), e("[data-nav] a").filter(function () {
            return t == e(this).attr("href") && "#" !== e(this).attr("href")
        }).parents("li").addClass("active")
    };
    r(), e(document).on("pjaxEnd", function () {
        r()
    });
    ...
    }), t(), window.hexToRGB = function (e, t) {
